...
class Auxin_Metabox_View extends Auxin_Metabox_Model{
    ...
    public function get_field_edit_template( $field ){
        ...
        $output .= '<input class="aux-input-is-hidden" type="text" name="' .  esc_attr( $field['id'] ) . '"  id="' .  esc_attr( $field['id'] ) . '" value="' .  esc_attr( $field['value'] ) . '">';
        $output .= '<p>'. $field['description'].'</p>'.'</div>'. $this->section_row_end;
        return $output;
    }
        ...
        $output = sprintf( $this->section_row_start, $field['class_names'], $field['attributes'] ).
                ...
                '<div class="section-row-right" >'.
                    '<fieldset class="uploader" >'.
                        ...
                        sprintf( '<input type="text" name="%1$s" id="%1$s" value="%2$s" />' , esc_attr( $field['id'] ), esc_attr( $field['value'] ) ).
    ...
    public function get_field_googlefont( $field ){
        ...
        $output = sprintf( $this->section_row_start, $field['class_names'], $field['attributes'] ).
                ...
                '<div class="section-row-right" ><div class="typo_fields_wrapper typo_font_wrapper" >'.
                    sprintf( '<input type="text" class="aux-simple-gfont"  name="%1$s" id="%1$s" value="%2$s" />', esc_attr( $field['id'] ), esc_attr( $field['value'] ) ).
                    '</div>'.
                    '<p>'. $field['description'].'</p>'.
                '</div>'.
             $this->section_row_end;
    ...
    public function get_field_select( $field ){
        ...
        $output = sprintf( $this->section_row_start, $field['class_names'], $field['attributes'] ).
                '<label >' .$field['title']. '</label>'.
                '<div class="section-row-right" >'.
                    sprintf( '<select name="%1$s" id="%1$s" class="aux-meta-select" data-value="%2$s" style="width:150px" >', esc_attr( $field['id'] ), esc_attr( $field['value']  ) );
    ...
    public function get_field_select2( $field ){
        ...
        $output = sprintf( $this->section_row_start, $field['class_names'], $field['attributes'] ).
                '<label >' .$field['title']. '</label>'.
                '<div class="section-row-right" >'.
                    sprintf( '<select name="%1$s" id="%1$s" class="aux-orig-select2 aux-admin-select2 aux-select2-single" data-value="%2$s" style="width:150px" >', esc_attr( $field['id'] ), esc_attr( $field['value'] ) );
        ...
        $output = sprintf( $this->section_row_start, $field['class_names'], $field['attributes'] ).
                ...
                '<div class="section-row-right" >'.
                    '<div class="mini-color-wrapper" >'.
                        sprintf( '<input type="text" class="colorpickerField" name="%1$s" id="%1$s" value="%2$s" />', esc_attr( $field['id'] ), esc_attr( $field['value'] ) ).
                    '</div>'.
                    '<p>'. $field['description'].'</p>'.
                '</div>'.
            $this->section_row_end;
    ...
    public function get_field_textarea( $field ){
        ...
        $output = sprintf( $this->section_row_start, $field['class_names'], $field['attributes'] ).
                '<label >' .$field['title']. '</label>'.
                '<div class="section-row-right" >'.
                    sprintf( '<textarea name="%1$s" id="%1$s">%2$s', esc_attr( $field['id'] ), esc_textarea( $field['value'] ) ). '</textarea>'.
                    '<p >'. $field['description'].'</p>'.
                '</div>'.
             $this->section_row_end;
                ...
                '<div class="section-row-right" >'.
                    '<div class="axi-attachmedia-wrapper" >'.
                        sprintf( '<input type="text" name="%1$s" id="%1$s" value="%2$s"
                                 ...
                                 >',
                                 esc_attr( $field['id'] ), esc_attr( $field['value'] ),
